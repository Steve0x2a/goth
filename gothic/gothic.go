...
See https://github.com/casdoor/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/casdoor/goth/examples/main.go to see this in action.
*/
